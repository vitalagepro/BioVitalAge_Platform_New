// Configurazione del grafico usando Chart.js
/* const ctx = document.getElementById('visiteChart').getContext('2d');
const visiteChart = new Chart(ctx, {
    type: 'bar',
    data: {
    ...
    options: {
        responsive: true,
        maintainAspectRatio: false, // Importante per adattare il grafico al contenitore
...
document.addEventListener("DOMContentLoaded", () => {
    generateChart(document.getElementById('chart1').getContext('2d'), [140, 190, 230, 210, 180], 'BP Levels');
    generateChart(document.getElementById('chart2').getContext('2d'), [90, 100, 110, 120, 130], 'Sugar Levels');
    generateChart(document.getElementById('chart3').getContext('2d'), [80, 85, 90, 95, 100], 'Heart Rate');
    generateChart(document.getElementById('chart4').getContext('2d'), [180, 220, 240, 200, 210], 'Cholesterol');
});
