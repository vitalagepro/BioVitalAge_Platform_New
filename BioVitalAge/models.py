...
class Appointment(models.Model):
    ...
    tipologia_visita = models.CharField(max_length=100, choices=[('Appuntamento paziente', 'Appuntamento paziente'), ('Appuntamento Società', 'Appuntamento Società'), ('Appuntamento di gruppo', 'Appuntamento di gruppo')], blank=True, null=True)
    data = models.DateField(default=datetime.now)
    giorno = models.CharField(max_length=255, blank=True, null=True)
    orario = models.TimeField()
    durata = models.CharField(max_length=255, choices=[('30 minuti', '30 minuti'), ('1 ora', '1 ora'), ('2 ore', '2 ore')], blank=True, null=True)
    voce_prezzario = models.CharField(max_length=255, choices=[('Voce 1', 'Voce 1'), ('Voce 2', 'Voce 2'), ('Voce 3', 'Voce 3')], blank=True, null=True)
